...
execute if score #mv.n.t minevocal.var matches 12..98 if score #mv.n.power minevocal.var matches 200001..2000000000 run function minevocal:play/noise/lookup
