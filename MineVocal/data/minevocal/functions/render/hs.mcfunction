...
execute store success score #mv.test1 minevocal.var run data get storage minevocal:render temp.hs[0]
execute store success score #mv.test2 minevocal.var run data get storage minevocal:render temp.sp[0]
